...
public interface InterfaceServeurForum extends Remote {
    ...
    void unhideDiscussion(int id_discussion, String username) throws RemoteException;
    List<Discussion> getPrivateDiscussionsNotVisibleByUser(String username) throws RemoteException;
    void addUserToDiscussion(int id_discussion, String username) throws RemoteException;
}
